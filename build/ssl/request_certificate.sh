...
certbot/certbot certonly --webroot --register-unsafely-without-email --agree-tos --webroot-path=/data/letsencrypt --staging -d www.thehost.com -d www.www.thehost.com 
...
-v /docker-nginx-cf-mysql/build/ssl/www:/data/letsencrypt \
-v "/docker-volumes/var/log/letsencrypt:/var/log/letsencrypt" \
certbot/certbot certonly --webroot --email sconklin@dynaprice.com --agree-tos --no-eff-email --webroot-path=/data/letsencrypt -d www.thehost.com -d www.www.thehost.com
